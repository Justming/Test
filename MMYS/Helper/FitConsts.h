...
/***  细体 */
#define kUltraLightFont(s) [UIFont fontWithName:@"HelveticaNeue-UltraLight" size:s]
#define kThinFont(s) [UIFont fontWithName:@"HelveticaNeue-Thin" size:s]
...
//* 米麦云商主题色
#define MMYS_COLOR             [UIColor colorWithRed:238/255.0 green:74/255.0 blue:71/255.0 alpha:1]
