...
//    NSLog(@"=========微信支付参数==PayReq==========dict:%@",dict);
    if(dict != nil){
        ...
        req.package             = [dict objectForKey:@"pkg"];
        req.sign                = [dict objectForKey:@"sign"];
        
        [WXApi sendReq:req];
        //日志输出
//        NSLog(@"日志输出appid=%@\npartid=%@\nprepayid=%@\nnoncestr=%@\ntimestamp=%ld\npackage=%@\nsign=%@",@"wxe6c31febbd05d58d",req.partnerId,req.prepayId,req.nonceStr,(long)req.timeStamp,req.package,req.sign );
    }
}
